...
void ConsoleChatUI::repaintDisplayArea(bool lock_screenLock, bool partialRepaint)
{
      ...
      if (this->displayHistory.size() - this->displayHistoryVectorInputIndex >= this->displayAreaEndY - this->displayAreaBeginY)
      {
            std::cout << "\033[K"; // clear the line

            ++editBegin;
            ++editEnd;
            repaintEditArea(true, false, true);
            --editBegin;
            --editEnd;
...
void ConsoleChatUI::repaintEditArea(bool lock_screenLock, bool partialRepaint, bool onlyClear)
{
      ...
      if (!partialRepaint)
      {
            ...
            for (int i = this->editBegin + 1; i < this->editEnd; i++)
            {
...
void ConsoleChatUI::inputFunc_switch1_case_b()
{
      ...
      else if (this->editingMessageNumY != 0)
      {
            ...
            this->editCursorY--;
            this->editingMessageNumY--;
            this->editCursorX = this->editingMessage[this->editingMessageNumY].size();
